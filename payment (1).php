...
You can switch to a different driver at runtime.
    ...
    */
    ...
    'posfix' => [
        'apiUrl' => env('POSFIX_API_URL', 'api.posfix.com.tr'),
        'privateKey' => env('POSFIX_PRIVATE_KEY'),
        'publicKey' => env('POSFIX_PUBLIC_KEY'),
        'version' => env('POSFIX_VERSION', '1.0'),
        'testMode' => env('POSFIX_TEST_MODE', true),
        'apiVerificationUrl' => 'https://api.posfix.com.tr/rest/payment/threed',
        'callbackUrl' => 'https://campusta.com/verify/Posfix',
        'description' => 'Posfix Ödeme Sistemi',
    ...
    */
    'map' => [
        'posfix' => \Shetabit\Multipay\Drivers\Posfix\Posfix::class,
