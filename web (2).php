...
use App\Http\Controllers\Web\PosfixTestController;
...
Route::get('/payment/test', function () {
    return view('web.default.payment.test');
});

Route::get('/posfix-test', [PosfixTestController::class, 'test'])->name('posfix.test');





Route::get('/cart/status_pay', function () {
    $order = session('order');
    return view('web.default.cart.status_pay', compact('order'));
});
...
Route::group(['prefix' => 'payments'], function () {
    ...
    // Posfix için yeni rotalar
    Route::post('/posfix/process', 'PaymentController@posfixProcess')->name('payment.posfix.process');
    // routes/web.php
    Route::post('/posfix/callback/{id}', 'PaymentController@posfixCallback')->name('payment.posfix.callback');
    // Diğer rotalar
